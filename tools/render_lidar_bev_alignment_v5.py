...
Examples:
  python tools/render_lidar_bev_alignment_v5.py \
...
def evaluate_alignment(
    ...
    eval_mask = current_dynamic_mask | dynamic_actor_mask
    iou = masked_occupancy_iou(current_channel, channel, eval_mask)
    return {
        "iou": iou,
        "channel": channel,
