...
export DIFFUSIONDRIVE_STUCK_THRESHOLD=${DIFFUSIONDRIVE_STUCK_THRESHOLD:-}
export DIFFUSIONDRIVE_CREEP_DURATION=${DIFFUSIONDRIVE_CREEP_DURATION:-}
export DIFFUSIONDRIVE_CREEP_THROTTLE=${DIFFUSIONDRIVE_CREEP_THROTTLE:-}
