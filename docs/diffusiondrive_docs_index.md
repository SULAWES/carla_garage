...
- [diffusiondrive_lidar_diagnostics_20260715.md](diffusiondrive_lidar_diagnostics_20260715.md)：condition-v1 配对开环 LiDAR 归因、train-vs-online contract、轨迹跳变和下一步决策门槛。
