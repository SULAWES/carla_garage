...
./CarlaUE4 -RenderOffScreen -nosound
```

新开窗口

```bash
cd ~/ltr/syb_carla_garage
conda activate ltr_garage_2
```
...
export WORK_DIR=/share/home/u19666033/ltr/syb_carla_garage
...
```bash
python3 /share/home/u19666033/ltr/syb_carla_garage/leaderboard/leaderboard/leaderboard_evaluator_local.py \
  --agent team_code/diffusiondrive_agent.py \
  --track SENSORS \
  --routes /share/home/u19666033/ltr/syb_carla_garage/leaderboard/data/debug.xml \
  --checkpoint /share/home/u19666033/ltr/
```

```bash
python /share/home/u19666033/ltr/syb_carla_garage/leaderboard/leaderboard/leaderboard_evaluator_local.py \
  --agent team_code/diffusiondrive_agent.py \
  --track SENSORS
```